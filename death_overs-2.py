...
valid_balls = working_df[(working_df['wide'] == 0) & (working_df['noballs'] == 0)].copy()

# Creating a column for dot balls
valid_balls['is_dot'] = (valid_balls['runs_of_bat'] == 0) & (valid_balls['wicket_type'].isnull())
...
plt.figure(dpi = 250)
colors = ['seagreen' if x < 12 else 'darkred' for x in filtered_metrics['strike_rate']]
